...
# Read the data
load("./data/otu_filtered_merged.RData")
otu_data<- merged_data #.RData object is called merged_data 
```
...
# Plot lms 
NMDS_lm<- ggplot(nmds_df, aes(x = NMDS1, y = NMDS2)) +
...
save(NMDS_lm, file = "./Figures/NMDS_lm.RData")
