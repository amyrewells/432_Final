...
-   can we confirm that removing consensus lineage is appropraite?

-   conform that removing untreated dung samples is appropraite? (potentially we could test later on)
